...
@section('content')
<div class="row">
<form action="/updateaboutsection2" method="post" enctype="multipart/form-data">
@csrf
    ...
    <div class="x_title">
      <h2 class="sub_title">Page Content</h2>
        ...
        <div class="x_content">
                ...
                <a href="{{url('view_aboutsection2')}}" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Back</a>
