...
@section('content')
<div class="row">
<form action="/updateaboutsection4" method="post" enctype="multipart/form-data">
@csrf
      ...
      <h2 class="sub_title">Page Content</h2>
        ...
        <div class="x_content">
               ...
               <label for="exampleFormControlFile1">Image</label>
                ...
                <a href="{{url('view_aboutsection4')}}" class="btn btn-danger btn-lg active" role="button" aria-pressed="true">Back</a>
